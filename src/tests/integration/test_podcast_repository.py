...
async def podcast(db_session):
    file_insert_query = """
        ...
        VALUES
        ('561a3e46-1ef1-45f2-93ee-fb60e8dfc809', 'file_id', '2040-01-01', '/link')
    """
    ...
    insert_podcast_query = """
        ...
        (podcast_id, file_id)
        VALUES
        ('1908dba3-a679-4ec6-8881-0b03f5865f8d', '561a3e46-1ef1-45f2-93ee-fb60e8dfc809')
    """
    await db_session.execute(insert_podcast_query)
