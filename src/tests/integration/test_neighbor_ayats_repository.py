...
from repository.ayats.neighbor_ayats import NeighborAyatsRepository, AyatShort
...
async def test(db_session, ayats: list[int]):
    got = await NeighborAyatsRepository(db_session).get_ayat_neighbors(ayats[0])
